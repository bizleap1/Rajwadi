                    ...
                    >
                      ...
                      <div className="pt-2.5 sm:pt-3.5 flex items-start justify-between gap-2">
                        <div className="text-left flex-1 min-w-0">
                          {/* Product Name: Default Heritage Maroon (#5A1F2B, the hover color), turns Golden (#C6A15B) on hover */}
